...
TP, FN, FP, TN, P, R , Accuracy= result_eval(env.sess,env,X_test,X_adv,x_rectify,x_adc_rectify)
print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)

print("\nReducing color bits = 1")
x_redu_bit = reduce_color_bits(X_test,bit_depth = 1)
x_adv_redu_bit = reduce_color_bits(X_adv,bit_depth = 1)
TP, FN, FP, TN, P, R, Accuracy = result_eval(env.sess,env,X_test,X_adv,x_redu_bit,x_adv_redu_bit)
print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)
...
for pca_components in [1,5,10,20]:
    ...
    TP, FN, FP, TN, P, R, Accuracy = result_eval(env.sess,env,X_test,X_adv,X_pca,X_adv_pca)
    print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)

print('\nGenerating decenration data')
x_decentra = decentra_data(X_test)
X_adv_decentra = decentra_data(X_adv)
TP, FN, FP, TN, P, R, Accuracy = result_eval(env.sess,env,X_test,X_adv,x_decentra,X_adv_decentra)
print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)

print('\nGenerating randomization data')
x_rand = random(X_test)
X_adv_rand = random(X_adv)
TP, FN, FP, TN, P, R, Accuracy = result_eval(env.sess,env,X_test,X_adv,x_rand,X_adv_rand)
print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)
