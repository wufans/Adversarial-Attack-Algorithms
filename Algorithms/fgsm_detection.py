...
# TP, FN, FP, TN, P, R, Accuracy = result_eval(sess,env,X_test,X_adv,x_redu_bit,x_adv_redu_bit)
# print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)
...
# TP, FN, FP, TN, P, R, Accuracy = result_eval(sess,env,X_test,X_adv,X_pca,X_adv_pca)
# print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)

# print('\nGenerating decenration data')
# x_decentra = decentra_data(X_test)
# X_adv_decentra = decentra_data(X_adv)
# TP, FN, FP, TN, P, R, Accuracy = result_eval(sess,env,X_test,X_adv,x_decentra,X_adv_decentra)
# print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)

# print('\nGenerating randomization data')
# x_rand = random(X_test)
# X_adv_rand = random(X_adv)
# TP, FN, FP, TN, P, R, Accuracy = result_eval(sess,env,X_test,X_adv,x_rand,X_adv_rand)
# print("TP:",TP,"\nFN:",FN,"\nFP:",FP,"\nTN:",TN,"\nP:",P,"\nR:",R)
